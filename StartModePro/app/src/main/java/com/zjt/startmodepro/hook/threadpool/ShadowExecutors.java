...
public class ShadowExecutors {
    ...
    public static ExecutorService newMyExecutor(final String name) {
        return new ThreadPoolExecutor(NCPU, MAX_POOL_SIZE, 10_000, TimeUnit.MILLISECONDS, new LinkedBlockingQueue(128), new NamedThreadFactory(name));
    }
    ...
    public static ExecutorService newOptimizedSingleThreadExecutor(final String name) {
        ...
        executor.allowCoreThreadTimeOut(true);
        return new ShadowExecutors.FinalizableDelegatedExecutorService(executor);
    }
    ...
    private static final class FinalizableDelegatedExecutorService extends ShadowExecutors.DelegatedExecutorService {
