...
public class SoUtils {
    ...
    public static File getSoSourcePath2() {
    ...
    public static String getSoSourcePath() {
        ...
        final String rootSdcard = MyApplication.getContext().getFilesDir().getAbsolutePath();
    ...
    public static boolean copyAssetFile(AssetManager assetManager, String fromAssetPath, String toPath, String fileName) {
