package com.zjt.startmodepro.soloader;
 ...
 */
public class TestLoadSoActivity extends AppCompatActivity {

    private static final int REQUEST_CODE = 1000;
    private final String sdcardLibDir = MyApplication.getContext().getFilesDir().getAbsolutePath();// + "/libs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_load_so_layout);
        this.context = this;
        isSoExist = false;
        applyForPermissions();
...
//        });
    ...
    private void loadLibrary() {
        ...
        final String msg = new NativeTest().getStringFromNative();
