    ...
    static void scanJar(File jarFile, File destFile) {
        if (jarFile) {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                if (entryName.contains("com/alibaba/android/aroutet")) {
                    println("ScanUtil >>> : scanJar >>> entryName = "+entryName)
                }
                if (entryName.startsWith(ScanSetting.ROUTER_CLASS_PACKAGE_NAME)) {
                    ...
                    println("ScanUtil >>> : scanJar >>> entryName = "+entryName + "， destFile = " + destFile.absolutePath)
